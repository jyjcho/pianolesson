...
enum HTCScaleParallelLesson {
    static let lesson = Lesson(
        id: "ht-c-scale-parallel",
        title: "HT: C Scale Parallel",
        category: .scalesChords,
        summary: "Both hands C scale one octave apart, moving in parallel. LH starts C3, RH starts C4. Same fingers, same rhythm.",
        measures: [
            Measure(notes: [
                .note(pitches: [Pitch(.C, 3), Pitch(.C, 4)], duration: .quarter, finger: 5),
